...
public class MazeBuilder implements Runnable {
	...
	public int rooms; 		// requested number of rooms in maze, a room is an area with no walls and larger than a single cell
	...
	// constants
	static final long SLEEP_INTERVAL = 1000 ; //constant used for brief breaks to recognize interrupted signal, unit is millisecond
